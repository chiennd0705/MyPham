...
namespace Common
{
    ...
    public partial class BuyGroup365Entities : DbContext
    {
        ...
        public DbSet<TextHtml> TextHtmls { get; set; }
        ...
        public DbSet<ConfigRedirectUrl> ConfigRedirectUrls { get; set; }
        public DbSet<ProductImagesPrice> ProductImagesPrices { get; set; }
        public DbSet<Product> Products { get; set; }
        public DbSet<FriendlyUrl> FriendlyUrl { get; set; }
        public DbSet<Menus> Menus { get; set; }
        public DbSet<CatalogProducts> CatalogProducts { get; set; }
        public DbSet<News> News { get; set; }
        public DbSet<NewsGroups> NewsGroups { get; set; }
        public DbSet<CommentsNew> CommentsNew { get; set; }
        public DbSet<PromotionItem> PromotionItem { get; set; }
        public DbSet<PromotionList> PromotionList { get; set; }
        public DbSet<Videos> Videos { get; set; }
        public DbSet<CatalogDownloads> CatalogDownloads { get; set; }
        public DbSet<Downloads> Downloads { get; set; }
        public DbSet<OrderSitting> OrderSittings { get; set; }
        ...
        public virtual ObjectResult<SearchNewByName_Result> SearchNewByName(string name)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchNewByName_Result>("SearchNewByName", nameParameter);
        }
    
        public virtual ObjectResult<SearchProductByName_Result> SearchProductByName(string name)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchProductByName_Result>("SearchProductByName", nameParameter);
        }
        ...
        public virtual ObjectResult<SearchProductByName1_Result> SearchProductByName1(string name)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchProductByName1_Result>("SearchProductByName1", nameParameter);
        }
    
        public virtual ObjectResult<SearchNewByGroupID_Result> SearchNewByGroupID(Nullable<long> id, Nullable<int> pageNum, Nullable<int> pageSize)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchNewByGroupID_Result>("SearchNewByGroupID", idParameter, pageNumParameter, pageSizeParameter);
        }
    }
}
