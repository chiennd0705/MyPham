    ...
    function _qsJnit() {
        ...
        qsHandlerImg.fancybox({
            ...
            beforeShow: function () {
                ...
                //alert('12');
                btnCart.magiccart({ url: getMagicUrl('ajax') });
                ...
                quickview.find(".product-image-thumbs").bxSlider({ infiniteLoop: true, minSlides: 3, visibleItems: 3, maxSlides: 3, slideMargin: 20, slideWidth: Themecfg.detail.slideWidth, mode: modeSlide, controls: parseInt(Themecfg.detail.controls), pager: parseInt(Themecfg.detail.pager), responsiveBreakpoints: { 480: 3, 640: 4, 768: 3, 900: 3 } });
